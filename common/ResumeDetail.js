        ...
        <div className="bg-[#F5F7F9] md:rounded-[15px] p-6 flex flex-col gap-8 justify-start w-full">
          <div className="bg-white rounded-[15px]">
            ...
            <div className=" grid grid-cols-1 md:grid-cols-2  gap-10 p-6 justify-items-center items-center ">
              ...
              <div className="w-full">
                <div className="flex justify-start flex-col gap-1 w-full">
                  <div className="font-semibold text-[15px]">Current City</div>
                  <input
                    type="text"
                    name="city"
                    value={state.city}
            ...
            <div className=" grid grid-cols-1 md:grid-cols-2  gap-10 p-6 justify-items-center items-center ">
              ...
              <div className="w-full">
                <div className="flex justify-start flex-col gap-1 w-full">
                  <div className="font-semibold text-[15px]">Date of Birth</div>
                  <input
                    type="date"
                    name="currentCity"
            ...
            {state.workExperience.map((item, index) => (
              <>
                ...
                >
                  ...
                  <div className=" grid grid-cols-1 md:grid-cols-4  gap-10 p-6 justify-items-center items-center ">
                    <div className="w-full">
                      <div className="flex justify-start flex-col gap-1 w-full">
                        <div className="text-[#000] text-[15px] font-semibold">
                          Start Date
                    ...
                    <div className="w-full">
                      <div className="flex justify-start flex-col gap-1 w-full">
                        <div className="text-[#000] text-[15px] font-semibold"></div>
                        <select
                          className="bg-[#F5F7F9] px-3 py-[10px] md:mt-6 rounded-[7px] text-sm text-[#000] text-opacity-30"
                          name="year"
                          value={state.year}
                          onChange={handleChange}
                        >
          ...
          <div className="bg-white rounded-[15px] pt-5">
            <div className="flex items-center justify-between md:pr-3">
              ...
              <button className="bg-secondary text-white font-s-medium px-8 py-2 text-sm">
                + Add More
              </button>
            </div>
            <div className="bg-black bg-opacity-60 h-[1px]"></div>
          ...
          <div className="bg-white rounded-[15px] pt-5">
            ...
            <div className="flex py-4 px-12 ">
              <input
                className="lg:px-3  lg:pl-2 pl-1  py-2 w-full lg:placeholder:text-sm placeholder:text-xs placeholder:pl-2 rounded-l-full border-l-[1.5px] border-y-[1.5px] border-secondary "
                type="text"
                id="job"
                name="skills"
                value={skill}
              ...
              />
              <div className="  px-5 py-3 bg-white rounded-r-full border-r-[1.5px] border-y-[1.5px] border-secondary">
                <img
                  alt=""
                  src="/assets/images/glass-search.png"
                  name="skills"
            ...
            {state.skills.map((item, index) => (
              <div className="px-12 py-2">
                <button className="flex gap-4 items-center bg-secondary text-white font-s-medium py-3 px-4 text-sm rounded-full">
                  <p className="font-s-regular text-sm text-white "> {item} </p>
                  <ImCross
                    onClick={() => handleRemoveSkill(item, index)}
          ...
          <div className="bg-white rounded-[15px] pt-5">
            ...
            {state.linkKnown.map((item, index) => (
              <>
                <div className="flex justify-end pt-6 px-4 ">
                  <ImBin
                    onClick={() => {
                      const newState = state.linkKnown.filter(
                        (obj) => obj.id !== item.id
                      );
                    ...
                    <div className="w-full">
                      <div className="flex justify-start flex-col gap-1 w-full">
                        ...
                        <input
                          ...
                          value={item.link1}
                          onChange={(e) => {
                            const newState = state.languagesKnown.map((obj) => {
                              if (obj.id === item.id) {
                                return { ...obj, levels: e.target.value };
                              }
          ...
          <div className="bg-white rounded-[15px] pt-5">
            ...
            {state.languagesKnown.map((item, index) => (
              <div>
                ...
                <div className=" grid grid-cols-1 md:grid-cols-2  gap-10 px-6 pb-6 justify-items-center items-center ">
                  <div className="w-full">
                    <div className="flex justify-start flex-col gap-1 w-full">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          const newState = state.languagesKnown.map((obj) => {
                            if (obj.id === item.id) {
                              return { ...obj, language: e.target.value };
                            }
                  ...
                  <div className="w-full">
                    <div className="flex justify-start flex-col gap-1 w-full">
                      <div className="font-semibold text-[15px]">Levels</div>
                      <input
                        type="text"
                        name="levels"
                        value={item.levels}
