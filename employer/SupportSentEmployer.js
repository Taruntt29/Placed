...
import { getSentAssistantEmailAPI } from "../../../api/authService";

const SupportSentEmployer = () => {
  ...
  const getAllSentMails = async () => {
    const { data, message, status } = await getSentAssistantEmailAPI(fromMail);
    if (status) {
      setMailData(data);
  ...
  return (
    <>
      <div className="bg-inputcolor  lg:px-0 px-5 pb-5">
        <Link to="/coach/support-inbox-mail">
              ...
              <Menu as="div" className="relative inline-block text-left">
                ...
                >
                  <Menu.Items className="absolute pt-2  mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <div className="px-3  ">
                      <Link to="/employer/support-compose-mail">
                        <Menu.Item>
                          {({ active }) => (
                            <div
                              className={`${
                      ...
                      <Link to="/employer/support-inbox-mail">
                        <Menu.Item>
                          {({ active }) => (
                            <div
                              className={`${
              ...
              >
                ...
                <div className="col-span-9 flex justify-between">
                  <div>
                    ...
                    <div
                      onClick={() =>
                        navigate("/employer/support-reply-mail", {
...
export default SupportSentEmployer;
