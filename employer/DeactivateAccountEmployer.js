...
const DeactivateAccountEmployer = () => {
  ...
  const deactivateAccount = async () => {
    try {
      const { data, status, message } = await putActivateAccountAPI({
        id: userDetails._id,
...
export default DeactivateAccountEmployer;
