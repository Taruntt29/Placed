...
//   const optionspassingyear2 = [
//     { value: "1", label: "1" },
//     { value: "2", label: "2" },
//     { value: "3", label: "3" },
//   ];

//   const optionscoursetype2 = [
//     { value: "1", label: "1" },
//     { value: "2", label: "2" },
//     { value: "3", label: "3" },
//   ];

//   const optionspassingyear1 = [
//     { value: "1", label: "1" },
//     { value: "2", label: "2" },
//     { value: "3", label: "3" },
//   ];
...
//         navigate(`/candidate-workexperience`);
//       } else {
//         toast(response.message);
//       }
//       console.log(response);
...
//                       >
//                         Add Class XII Details<span className="text-red-500">*</span>
//                         {toggleone ? (
...
//                           className=" p-3 flex justify-between"
//                         >
//                           Add Class X Details<span className="text-red-500">*</span>
//                           {select ? (
...
export default function EducationEdit() {
  ...
  const GetCandidateProfile = async () => {
    try {
      const response = await candidateProfileGetAPI(userDetails._id || candidateId);
  ...
  return (
    ...
    <div className="container mx-auto md:px-5  md:py-20">
      <div className="flex space-x-2 items-center pb-6 lg:px-0 px-5">
        {" "}
        <RiArrowLeftSLine className="text-secondary w-5 h-5 " />{" "}
        <p className="text-secondary font-s-medium text-base"> Create Profile </p>{" "}
      </div>
      <div className=" md:w-[50%] grid md:grid-cols-3 grid-cols-1   rounded  justify-items-start items-center mx-4 border-buttonsome py-2 px-2  ">
        <NavLink
          to={`/candidate-create-profile`}
                          ...
                          <div className="flex justify-start flex-col gap-1 w-full">
                            ...
                            {/* <div className="relative">
                                  <DatePicker
                                    ...
                                    // }}
                                    selected={elementAd.passingYearAd}
                                    // value={elementAd.passingYearAd}
                                    onChange={(e) =>
                                      handleChangeAdditionalDegree(index, e)
                                    }
