        ...
        <div className=" lg:px-8 px-5 py-8">
          ...
          <div className="shadow-email rounded-b-md ">
            <div className=" px-5">
                ...
                <input type="radio" id = "coach" value="coach" name="radio" onChange={(e) => {setState({...state , entryfor : e.target.value})}}/>
                <label for="coach">Coach</label>
                <input type="radio" id = "employer" value="employer" name="radio" onChange={(e) => {setState({...state , entryfor : e.target.value})}}/>
                <label for="employer">Employer</label>
                <input type="radio" id = "support" value="support" name="radio" onChange={(e) => setState({...state , entryfor : e.target.value})}/>
              ...
              <div className="flex items-start space-x-4 p-3  border-gray-200 border-b-2">
                ...
                <input name="To" value={state.To} onChange={handleChange} />
              </div>
            </div>
...
export default ComposeMailCandidate;
