    ...
    <div className="bg-inputcolor">
      <div className="container mx-auto lg:px-20 px-5 pb-16 ">
        ...
        <div className="container mx-auto pt-5  bg-white   rounded">
          <div className="lg:flex space-x-4 px-5 pb-4 border-gray-200 border-b-2">
          ...
          <div className=" bg-white rounded-md ">
            <div className="  p-7 ">
              <div className=" ">
                {sender.map((item) => (
                  <>
                    <div className="grid lg:grid-cols-12 lg:w-[80%] w-full  gap-2 ">
                    ...
                    <div className="lg:pl-[770px] py-5">
...
export default SupportChatCoach;
