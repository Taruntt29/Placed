...
const SupportSentMailCoach = () => {
  ...
  const getAllSentMails = async () => {
    const { data, message, status } = await getAllSentAssistantEmails(fromMail);
    if (status) {
      setMailData(data);
              ...
              <Menu as="div" className="relative inline-block text-left">
                ...
                >
                  <Menu.Items className="absolute pt-2  mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <div className="px-3  ">
                      <Link to="/coach/support-compose-mail">
                        <Menu.Item>
                          {({ active }) => (
                            <div
                              className={`${
              ...
              >
                ...
                <div className="col-span-9 flex justify-between">
                  <div>
                    ...
                    <div
                      onClick={() =>
                        navigate("/coach/support-reply-mail", {
...
export default SupportSentMailCoach;
